...
export default function Collaboration() {
  ...
  const getAISummary = async () => {
    ...
    const result = await base44.integrations.Core.InvokeLLM({
      prompt: `You are a GTM team intelligence assistant. Summarize this team activity and provide 2-3 strategic recommendations based on the following comments and context:
