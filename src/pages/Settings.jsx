...
export default function Settings() {
  ...
  const [profile, setProfile] = useState({ name: 'John Doe', email: 'john@tryorbin.ai', title: 'Head of Sales', phone: '+234 810 000 0000' });
  ...
  const [mailboxes, setMailboxes] = useState([
    { email: 'john@tryorbin.ai',      provider: 'gmail',   label: 'Primary',   state: 'connected',   lastSync: '2 min ago', stats: { Sent: 54, Received: 12, Tracked: 41 } },
    { email: 'outreach@tryorbin.ai',  provider: 'gmail',   label: 'Outreach',  state: 'connected',   lastSync: '5 min ago', stats: { Sent: 180, Received: 3, Tracked: 154 } },
    { email: 'sales@tryorbin.ai',     provider: 'outlook', label: 'Sales',     state: 'expired',     lastSync: '2d ago',    stats: null, errorMessage: 'Session token expired — reconnect to resume sync' },
  ]);
            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
              <Section title="Team & Access">
                <div className="space-y-3 mb-5">
                  {[
                    { name: 'John Doe', email: 'john@tryorbin.ai', role: 'Admin', avatar: 'JD', status: 'active' },
                    { name: 'Sara Boateng', email: 'sara@tryorbin.ai', role: 'Member', avatar: 'SB', status: 'active' },
                    { name: 'Ama Mensah', email: 'ama@tryorbin.ai', role: 'Member', avatar: 'AM', status: 'invite_pending' },
                  ].map(m => (
